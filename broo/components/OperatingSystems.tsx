...
const osData = [
  { name: 'Ubuntu', image: 'https://i.imgur.com/2T18d3p.png' },
  { name: 'Windows', image: 'https://i.imgur.com/so4A264.png' },
  { name: 'Fedora', image: 'https://i.imgur.com/s4f312v.png' },
  { name: 'Debian', image: 'https://i.imgur.com/2yo0l4T.png' },
  { name: 'Kali Linux', image: 'https://i.imgur.com/yHMm32w.png' },
