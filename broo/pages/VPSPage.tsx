...
const CloudBackground: React.FC = () => (
    <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-purple-600/50 rounded-full blur-3xl animate-cloud-pulse"></div>
        <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-indigo-600/50 rounded-full blur-3xl animate-cloud-pulse" style={{animationDelay: '5s'}}></div>
        <div 
...
const FloatingDataCube: React.FC = () => (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 opacity-20 hidden md:block" style={{ perspective: '1000px' }}>
        <div className="relative w-full h-full animate-float-cube" style={{ transformStyle: 'preserve-3d' }}>
            {/* Cube Faces */}
            <div className="absolute w-full h-full border-2 border-purple-400/50 bg-purple-900/10" style={{ transform: 'rotateY(0deg) translateZ(96px)' }}></div>
            <div className="absolute w-full h-full border-2 border-purple-400/50 bg-purple-900/10" style={{ transform: 'rotateY(90deg) translateZ(96px)' }}></div>
            <div className="absolute w-full h-full border-2 border-purple-400/50 bg-purple-900/10" style={{ transform: 'rotateY(180deg) translateZ(96px)' }}></div>
            <div className="absolute w-full h-full border-2 border-purple-400/50 bg-purple-900/10" style={{ transform: 'rotateY(-90deg) translateZ(96px)' }}></div>
            <div className="absolute w-full h-full border-2 border-purple-400/50 bg-purple-900/10" style={{ transform: 'rotateX(90deg) translateZ(96px)' }}></div>
            <div className="absolute w-full h-full border-2 border-purple-400/50 bg-purple-900/10" style={{ transform: 'rotateX(-90deg) translateZ(96px)' }}></div>
        </div>
    </div>
);
    ...
    return (
        <div className="bg-card-bg-solid/80 backdrop-blur-md border border-white/10 rounded-xl p-6 flex flex-col transition-all duration-300 hover:border-accent-purple/50 hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-900/50">
            ...
            <div className="border-t border-white/10 pt-4 mt-4 flex justify-between items-center">
                ...
                <button className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold py-2 px-5 rounded-lg hover:opacity-90 transition-opacity">
                    Deploy
                </button>
            </div>
        </div>
