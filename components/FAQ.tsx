  ...
  return (
    <section className="py-16 md:py-24 relative">
        <div className="fixed bottom-6 left-6 z-50">
            <button className="bg-brand-purple hover:opacity-90 text-white w-14 h-14 rounded-full flex items-center justify-center text-2xl shadow-lg transition-opacity animate-pulse-glow-purple">
