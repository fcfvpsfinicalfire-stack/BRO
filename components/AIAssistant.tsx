...
- Never reveal you are a language model or AI. You are 'Codey'.`,
    ...
    const UserMessage: React.FC<{text: string}> = ({ text }) => (
        <div className="flex justify-end mb-4">
            <div className="bg-indigo-600 text-white rounded-lg rounded-br-none py-2 px-4 max-w-sm">
                {text}
            </div>
        </div>
    );
    ...
    return (
        <>
                    ...
                    <div className="p-4 border-t border-white/10">
                        <form onSubmit={handleSendMessage} className="flex space-x-2">
                            <input
                                ...
                                className="flex-1 bg-gray-900/80 border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-accent-purple"
                                disabled={isLoading}
                            />
                            <button
                                type="submit"
                                className="bg-accent-purple text-white font-bold w-12 h-10 rounded-lg flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
                ...
                className="fixed bottom-6 right-4 sm:right-6 lg:right-8 z-50 w-16 h-16 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-full text-white flex items-center justify-center text-3xl shadow-lg transform transition-all duration-300 hover:scale-110 animate-pulse-glow-purple"
